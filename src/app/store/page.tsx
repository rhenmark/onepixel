...
import { Button, Card, InputNumber, List, Splitter, Typography } from "antd";
...
function Store() {
  return (
    <div className="grid grid-rows-[80px_1fr] text-white box-border h-dvh max-h-screen overflow-hidden">
        <Header showNav/>
